...
| `build_dynamic_memprof.cmd` | Сборка динамической отладочной версии с включенным профилированием памяти                                                                                            |
| `build_static_memprof.cmd`  | Сборка статической отладочной версии с включенным профилированием памяти                                                                                             |
