...
namespace Kkm {
    ...
    enum class ReceiptType : std::remove_cv_t<decltype(Atol::LIBFPTR_RT_CLOSED)> {
    ...
    enum class DocumentType : std::remove_cv_t<decltype(Atol::LIBFPTR_DT_CLOSED)> {
    ...
    enum class MeasurementUnit : std::remove_cv_t<decltype(Atol::LIBFPTR_IU_PIECE)> {
    ...
    enum class Tax : std::remove_cv_t<decltype(Atol::LIBFPTR_TAX_NO)> {
